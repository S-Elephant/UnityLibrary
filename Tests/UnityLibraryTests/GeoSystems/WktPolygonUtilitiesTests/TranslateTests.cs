...
namespace UnityLibraryTests.GeoSystems.WktPolygonUtilitiesTests
{
	...
	public class TranslateTests
	{
		...
		/// <summary>
		/// Simple <see cref="WktPolygonUtils.Translate(string,UnityEngine.Vector2)"/> test.
		/// </summary>
		[Theory]
		...
		public void TranslateReturnsAsExpected(string wktString, float translationX, float translationY,  string expected)
		{
			...
			var result2 = WktPolygonUtils.Translate(WktPolygonParser.ParseWkt(wktString), new Vector2(translationX, translationY));
